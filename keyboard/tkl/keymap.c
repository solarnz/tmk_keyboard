...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* 0: qwerty */
    KEYMAP_ANSI( \
        ESC,  F1, F2,  F3,  F4,  F5,  F6,  F7,  F8,  NO,  F9,  F10,F11,F12,         PSCR,SLCK, \
        GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSPC,      INS, HOME, \
        TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSLS,      DEL, END, \
        LSFT,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,ENT, PGDN,        NO,RIGHT,\
        LSFT,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,NO,  RSFT,NO,        PGUP,UP,\
        LCTL,LGUI,LALT,NO,  NO,  SPC, NO,  NO,  NO,  RALT,RGUI, NO ,FN0, RCTL,      LEFT,DOWN \
    ),
    KEYMAP_ANSI( \
        TRNS,MUTE,VOLD,VOLU,MPLY,MSTP,MPRV,MNXT,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, \
