...
static const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* 0: qwerty */
    KEYMAP_ANSI(
        F1,     F2,     F3,     F4,     F5,     F6,     MPRV,   MPLY,   MNXT,   MUTE,   VOLD,   VOLU,   NO, \
        NO,     BSLS,   ESC,    NO,     NO,     NO,     FN0,    NLCK,   NO,     NO,     NO,     RBRC,   EQL,  \
        GRV,    1,      2,      3,      4,      5,      LGUI,   6,      7,      8,      9,      0,      MINS, \
        SLASH,  Q,      W,      E,      R,      T,      DEL,    Y,      U,      I,      O,      P,      LBRC, \
        LSFT,   A,      S,      D,      F,      G,      TAB,    H,      J,      K,      L,      SCLN,   RSFT, \
        TAB,    Z,      X,      C,      V,      B,      BSPC,   N,      M,      COMM,   DOT,    QUOT,   ENT, \
        LCTRL,  HOME,   PGUP,   PGDN,   END,    BSPC,   LGUI,   SPC,    LEFT,   UP,     DOWN,   RIGHT,  RALT  \
    ),
    /* 1: first FN layer */
    KEYMAP_ANSI(
